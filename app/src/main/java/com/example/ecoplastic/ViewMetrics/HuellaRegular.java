...
public class HuellaRegular extends View {
    Paint barPaint;
    Paint contPaint;
    Paint textPaint;

    public HuellaRegular(Context context) {
        super(context);
    }
    public HuellaRegular(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    public HuellaRegular(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected  void onDraw(Canvas canvas){
        ...
        Rect elementCal = new Rect(leftE, topE+alto/2, rigthE, bottonE);
    ...
    private void init(){
        ...
        contPaint.setColor(Color.YELLOW);
