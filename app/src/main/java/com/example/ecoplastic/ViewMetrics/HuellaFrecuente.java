...
public class HuellaFrecuente extends View {
    Paint barPaint;
    Paint contPaint;
    Paint textPaint;

    public HuellaFrecuente(Context context) {
        super(context);
    }
    public HuellaFrecuente(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    public HuellaFrecuente(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected  void onDraw(Canvas canvas){
        ...
        Rect elementCal = new Rect(leftE, topE+alto/4, rigthE, bottonE);
    ...
    private void init(){
        ...
        contPaint.setColor(Color.parseColor("#F27E00"));
