...
public class HuellaBaja extends View {
    Paint barPaint;
    Paint contPaint;
    Paint textPaint;

    public HuellaBaja(Context context) {
        super(context);
    }
    public HuellaBaja(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    public HuellaBaja(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected  void onDraw(Canvas canvas){
        ...
        Rect elementCal = new Rect(leftE, topE+alto*3/4, rigthE, bottonE);
    ...
    private void init(){
        ...
        contPaint.setColor(Color.GREEN);
